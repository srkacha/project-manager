...
<div class="activity-participant-index">
    ...
    $gridColumn = [
        ...
        [
                'attribute' => 'task_participant_id',
                'label' => 'Task Participant',
                'value' => function($model){                   
                    return $model->taskParticipant->id;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\models\TaskParticipant::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
        ...
        [
                ...
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\models\Activity::find()->asArray()->all(), 'id', 'id'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
